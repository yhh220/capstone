<button id="filament-scroll-to-top"
        ...
        type="button"
        class="fixed bottom-6 right-6 z-50 w-10 h-10 flex items-center justify-center rounded-full bg-rose-600 text-white shadow-2xl transition-all duration-500 translate-y-24 opacity-0 pointer-events-none hover:bg-rose-500 hover:-translate-y-1 active:scale-95 focus:outline-none focus:ring-4 focus:ring-rose-500/30 group">
