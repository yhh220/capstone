            ...
            <div data-aos="fade-left" data-aos-delay="80">
                ...
                <div class="flex flex-col sm:flex-row gap-3 mb-8">
                    <a href="{{ $whatsAppUrl }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="group relative overflow-hidden flex-1 flex justify-center items-center gap-2 bg-[#25D366] text-white py-3 px-8 rounded-full font-bold text-lg transition-all duration-300 shadow-lg hover:shadow-[0_4px_15px_rgba(37,211,102,0.4)] hover:-translate-y-0.5 active:scale-95">
                        <span class="absolute inset-0 w-full h-full bg-white/20 -translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out"></span>
                    ...
                    <a href="{{ $mapUrl }}"
                       target="_blank"
                       rel="noopener noreferrer"
                       class="group relative overflow-hidden flex-1 flex justify-center items-center gap-2 border-2 border-brand-black dark:border-white text-brand-black dark:text-white py-3 px-8 rounded-full font-bold text-lg transition-all duration-300 hover:bg-brand-black hover:text-white dark:hover:bg-white dark:hover:text-brand-black hover:-translate-y-0.5 active:scale-95">
                        ...
                        <svg class="w-5 h-5 relative z-10 group-hover:-translate-y-1 transition-transform duration-300" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>
