                        ...
                        <button wire:click="goToStep({{ $num }})"
                            ...
                            <div class="text-left min-w-0">
                                ...
                                @if($num === 1 && $currentStep > 1)
                                    <p class="text-xs text-gray-400 truncate mt-0.5">{{ $selectedService ? $selectedService->localized_name : __('General visit') }}</p>
                    ...
                    <div class="mt-5 bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-start gap-2">
                                ...
                                <span class="text-xs font-bold text-gray-800 dark:text-gray-200 text-right">{{ $selectedService ? $selectedService->localized_name : __('General visit') }}</span>
                            </div>
                            @if($preferred_date)
                            <div class="flex justify-between items-start gap-2">
                    ...
                    <div class="px-6 sm:px-8 py-7">
                        ...
                        <div x-data="{ selected: $wire.entangle('service_id') }" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <button @click="selected = '{{ $svc->id }}'"
                                ...
                                <p class="font-black text-gray-900 dark:text-white text-sm leading-tight mb-1">{{ $svc->localized_name }}</p>

                                @if($svc->description)
                                <p class="text-xs text-gray-400 leading-relaxed line-clamp-2">{{ $svc->localized_description }}</p>
                                @endif
                            </button>
                            @endforeach
                        </div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex gap-3 items-start pb-3 border-b border-gray-100 dark:border-white/10">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm font-bold text-gray-900 dark:text-white">{{ $selectedService->localized_name }}</p>
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        <div class="flex items-center justify-between pt-1">
                                            ...
                                            <span class="text-sm font-bold text-gray-900 dark:text-white text-right">{{ $selectedService ? $selectedService->localized_name : __('General visit') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
