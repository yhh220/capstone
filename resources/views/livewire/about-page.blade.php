<div>
    ...
    {{-- This panel is brand-red in BOTH themes, so the theme-aware brand-yellow
         accent must not be used inside it: in light mode that variable resolves
         to Ember Light (#E86460), a light red that vanishes against the red
         cards. Icons/headings are pinned to Bone White (#E8E0D8) instead — the
         exact colour brand-yellow already resolves to in dark mode, so dark
         mode looks identical and light mode becomes readable. --}}
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="group bg-white/10 ring-1 ring-white/15 rounded-2xl p-6 text-center hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.2)]" data-aos="fade-up" data-aos-delay="0">
                    <div class="flex justify-center mb-4 text-[#E8E0D8]" aria-hidden="true">
                    ...
                    <h3 class="text-xl font-bold text-[#E8E0D8] mb-2">{{ __('Quality First') }}</h3>
                ...
                <div class="group bg-white/10 ring-1 ring-white/15 rounded-2xl p-6 text-center hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.2)]" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <h3 class="text-xl font-bold text-[#E8E0D8] mb-2">{{ __('Customer Trust') }}</h3>
                ...
                <div class="group bg-white/10 ring-1 ring-white/15 rounded-2xl p-6 text-center hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(0,0,0,0.2)]" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <h3 class="text-xl font-bold text-[#E8E0D8] mb-2">{{ __('Practical Guidance') }}</h3>
