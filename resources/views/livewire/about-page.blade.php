    ...
    <section class="py-16 bg-white dark:bg-gray-800" aria-labelledby="story-heading">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="bg-gray-100 dark:bg-gray-700 rounded-2xl h-80 flex items-center justify-center text-8xl" role="img" aria-label="Car illustration">🚗</div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                @foreach([
                    ...
                    ['10,000+', __('Customers served')],
                    ['1:1', __('Personal consultation')],
                ] as [$number, $label])
                <div>
                    <div class="text-4xl sm:text-5xl font-black text-brand-yellow mb-2">{{ $number }}</div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    <div class="w-24 h-24 bg-brand-red text-white rounded-full flex items-center justify-center text-3xl font-black mx-auto mb-4" aria-hidden="true">
                        {{ substr($name, 0, 1) }}
                    </div>
