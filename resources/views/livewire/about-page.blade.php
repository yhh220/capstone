        ...
        <div class="max-w-2xl mx-auto px-4" data-aos="zoom-in">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
                <a href="{{ $whatsAppUrl }}"
                   ...
                   class="group relative inline-flex items-center justify-center gap-3 bg-[#25D366] text-white px-8 py-4 sm:px-10 sm:py-4 rounded-full font-black text-base sm:text-lg transition-all duration-300 shadow-[0_6px_20px_rgba(37,211,102,0.3)] overflow-hidden hover:shadow-[0_10px_30px_rgba(37,211,102,0.45)] hover:-translate-y-2 active:scale-95">
                ...
                <a href="{{ $mapUrl }}"
                   target="_blank"
                   rel="noopener noreferrer"
                   class="group relative inline-flex items-center justify-center gap-3 border-2 border-brand-black dark:border-white text-brand-black dark:text-white px-8 py-4 sm:px-10 sm:py-4 rounded-full font-black text-base sm:text-lg overflow-hidden hover:bg-brand-black hover:text-white dark:hover:bg-white dark:hover:text-brand-black hover:-translate-y-2 hover:shadow-2xl transition-all duration-500 active:scale-95">
