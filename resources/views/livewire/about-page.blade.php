    ...
    <section class="py-16 bg-white dark:bg-gray-800" aria-labelledby="story-heading">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="bg-gray-100 dark:bg-gray-700 rounded-2xl h-48 sm:h-64 lg:h-80 flex items-center justify-center" role="img" aria-label="Car illustration" data-aos="fade-left" data-aos-delay="100">
