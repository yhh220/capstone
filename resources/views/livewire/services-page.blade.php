<div>
    <div class="bg-brand-black text-white py-12">
        <div class="max-w-7xl mx-auto px-4">
            <h1 class="text-3xl sm:text-4xl font-black mb-2">{{ __('Our Services') }}</h1>
            <p class="text-gray-400">{{ __('Professional installation and modification services by our experienced team.') }}</p>
        </div>
    </div>
