                ...
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 mt-8">
                        ...
                        <a href="{{ $generalWhatsAppUrl }}" target="_blank" rel="noopener noreferrer"
                           class="btn btn-md btn-shine" style="background:#25D366;color:#fff;border-color:#25D366;">
                                ...
                                <div class="mt-auto">
                                    ...
                                    <div class="grid grid-cols-2 gap-2">
                                        ...
                                        <a href="{{ $serviceWhatsAppUrl }}" target="_blank" rel="noopener noreferrer"
                                           class="btn btn-sm btn-shine" style="background:#25D366;color:#fff;border-color:#25D366;">
                                            WhatsApp
                                        </a>
                                    </div>
                                </div>
    ...
    <section class="py-14 sm:py-20 bg-brand-red text-white" aria-labelledby="service-cta-heading">
        <div class="max-w-5xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                <a href="{{ route('booking') }}"
                   class="group inline-flex items-center justify-center border-2 border-white/80 px-8 py-4 rounded-xl font-black text-lg text-white hover:bg-white hover:text-brand-red hover:border-white hover:shadow-lg hover:-translate-y-1 active:scale-95 transition-all duration-300 w-full sm:w-auto">
