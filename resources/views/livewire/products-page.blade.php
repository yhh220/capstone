<div>
                    ...
                    <div wire:key="product-{{ $product->id }}" class="group bg-white dark:bg-gray-800 rounded-2xl shadow-sm hover:shadow-xl transition-shadow overflow-hidden border border-gray-100 dark:border-gray-700 flex flex-col">
                        <a href="{{ route('product.show', $product->slug) }}" wire:navigate class="block flex-1">
                            ...
                            <div class="p-4 pb-3">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mb-2 line-clamp-2">{{ $product->translated_short_description }}</p>
                                @endif
                                {{-- Price display --}}
                                @if($shoppingEnabled)
                        ...
                        <div class="px-4 pb-4 flex gap-2">
                            ...
                            @else
                                ...
                                <a href="{{ $productWaUrl }}"
                                   ...
                                   aria-label="{{ __('Enquire about') }} {{ $product->translated_name }} {{ __('on WhatsApp') }}">
    ...
    <div id="configurator-modal" role="dialog" aria-modal="true" aria-label="{{ __('3D Car Configurator') }}"
         data-model-url="{{ asset('models/3d/car-draco.glb') }}?v={{ @filemtime(public_path('models/3d/car-draco.glb')) ?: 1 }}">
        <!-- Canvas Viewport -->
        <div class="configurator-viewport" id="configurator-viewport">
            ...
            <div class="configurator-controls-overlay">
                ...
                <button id="camera-reset-btn" class="circle-btn camera-btn" title="{{ __('Reset View') }}" aria-label="{{ __('Reset View') }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12a9 9 0 1 0 2.636-6.364L3 8"/><path stroke-linecap="round" stroke-linejoin="round" d="M3 3v5h5"/></svg>
                </button>
        ...
        <div class="configurator-sidebar">
            ...
            <!-- Enquiry CTA footer — pinned below the scrollable options list -->
