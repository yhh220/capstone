        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
                ...
                <a href="{{ route('products', ['category' => $category->id]) }}"
                   data-aos="fade-up"
                   class="category-card group bg-white dark:bg-gray-800 border-2 border-transparent rounded-3xl p-8 text-center hover:-translate-y-2 hover:shadow-2xl hover:shadow-brand-red/20 hover:border-brand-red active:scale-95">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="{{ $i * 100 }}"
                     class="group p-10 bg-gray-50 dark:bg-white/5 hover:bg-white dark:hover:bg-white/10 border border-gray-100 dark:border-white/10 rounded-[2.5rem] transition-all duration-500 shadow-sm hover:shadow-2xl hover:-translate-y-2">
                    <div class="mb-8 transform transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-6">{!! $icon !!}</div>
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center items-center" data-aos="fade-up" data-aos-delay="200">
                <a href="{{ $whatsAppUrl }}" target="_blank" rel="noopener noreferrer"
                   class="group relative inline-flex items-center justify-center bg-brand-yellow text-brand-black px-12 py-5 rounded-full font-black text-xl transition-all duration-300 shadow-[0_10px_40px_rgba(250,204,21,0.3)] overflow-hidden hover:shadow-[0_15px_50px_rgba(250,204,21,0.5)] hover:-translate-y-2 active:scale-95">
                ...
                <a href="{{ $mapUrl }}" target="_blank" rel="noopener noreferrer"
                   class="group inline-flex items-center justify-center border-2 border-white/80 px-12 py-5 rounded-full font-black text-xl hover:bg-white hover:text-brand-red hover:border-white hover:shadow-2xl hover:-translate-y-2 active:scale-95 transition-all duration-500">
