<div>
    <div class="bg-brand-black text-white py-12">
        <div class="max-w-7xl mx-auto px-4">
            <h1 class="text-3xl sm:text-4xl font-black mb-2">{{ __('Gallery') }}</h1>
            <p class="text-gray-400">{{ __('Browse our portfolio of installations and modifications.') }}</p>
        </div>
    </div>

    <div class="max-w-7xl mx-auto px-4 py-10">
        {{-- Category Filter --}}
        <div class="flex flex-wrap gap-2 mb-8" role="tablist" aria-label="{{ __('Filter gallery by category') }}">
        ...
        <div class="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 space-y-4">
            ...
            <div class="break-inside-avoid bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700 group">
