...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 font-sans antialiased">
    ...
    <button id="scroll-to-top"
            ...
            {{-- Stacked right above the chatbot launcher (their circles share a
                 centre line): the centre-bottom slot sat on top of mid-page
                 content like the services road, and bottom-left felt stranded. --}}
            class="fixed bottom-24 right-8 md:bottom-28 md:right-10 z-40 w-10 h-10 flex items-center justify-center rounded-full bg-brand-red text-white shadow-2xl transition-all duration-500 translate-y-20 opacity-0 pointer-events-none hover:bg-brand-red/90 hover:-translate-y-1 active:scale-95 focus:outline-none focus:ring-4 focus:ring-brand-red/30 group">
