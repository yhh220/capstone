        ...
        <div class="max-w-7xl mx-auto px-4 py-12">
            ...
            <div class="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 gap-3">
                ...
                <div class="flex flex-wrap items-center justify-center gap-x-4 gap-y-1">
                    ...
                    <a href="{{ config('services.store.status_url') }}" target="_blank" rel="noopener noreferrer" class="hover:text-brand-yellow active:text-brand-yellow transition-colors">
                        {{ __('System Status') }}
                    </a>
                </div>
            </div>
