...
<head>
    ...
    <title>{{ __('Server Error') }} - {{ config('services.store.seo_name') }}</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="code-badge">500 {{ __('Server Error') }}</div>

        <h1>{{ __('Something Went Wrong') }}</h1>
        <p>
            {{ __("We're experiencing some technical difficulties. Please try again later.") }}
        </p>
