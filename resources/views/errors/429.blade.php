...
<head>
    ...
    <title>{{ __('Too Many Requests') }} - {{ config('services.store.seo_name') }}</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="code-badge">429 {{ __('Too Many Requests') }}</div>

        <h1>{{ __('Slow down a little') }}</h1>
        <p>
            {{ __('You’ve made a lot of requests in a short time. Please wait a moment, then try again.') }}
        </p>
