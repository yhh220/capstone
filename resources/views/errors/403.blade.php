...
<head>
    ...
    <title>{{ __('Access Denied') }} - {{ config('services.store.seo_name') }}</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="code-badge">403 {{ __('Forbidden') }}</div>

        <h1>{{ __('Access Denied') }}</h1>
        <p>
            {{ __("You don't have permission to view this page. If you think this is a mistake, please sign in with the right account.") }}
        </p>
        ...
        <div class="btn-group">
            ...
            <a href="{{ route('login') }}" class="btn btn-primary" style="background: transparent; color: var(--rose); border: 1px solid rgba(244, 63, 94, 0.4);">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
