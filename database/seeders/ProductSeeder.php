...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        $categories = [
            ...
            'No Plate'       => 'Custom number plates and accessories.',
        ...
        $products = [
            ...
            ['No Plate', 'Generic', 'Custom Crystal Acrylic Number Plate', 80, 100, 'JPJ-compliant crystal clear acrylic number plate with 3D fonts.', '3D Font, High Durability', 'noplate_crystal.jpg'],
